...
app = faust.App("stations-stream", broker=["kafka://localhost:9092","kafka://localhost:9093","kafka://localhost:9094"], store="memory://")
...
table = app.Table(
   name="org.stations.transformation.table.v1",
